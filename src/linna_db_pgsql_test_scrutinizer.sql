...
DROP DATABASE scrutinizer;
--
-- TOC entry 3081 (class 1262 OID 21328)
-- Name: scrutinizer; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE scrutinizer WITH TEMPLATE = template0 ENCODING = 'UTF8' LC_COLLATE = 'en_US.UTF-8' LC_CTYPE = 'en_US.UTF-8';


ALTER DATABASE scrutinizer OWNER TO postgres;
